...
| `bsm3/core/boundary_surface_movement/embraer_175_panel_quad_dominant_high_quality.msh` | P, S | Curated, tracked quad-dominant panel with an inversion-free baseline; replaces the former 114-inversion example asset. |
